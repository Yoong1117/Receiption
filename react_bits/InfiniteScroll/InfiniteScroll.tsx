...
const InfiniteScroll: React.FC<InfiniteScrollProps> = ({
  ...
  useEffect(() => {
    ...
    let gsap: any, Observer: any;
    let rafId: number;

    const init = async () => {
      const gsapPkg = await import("gsap");
      const ObserverPkg = await import("gsap/Observer");

      gsap = gsapPkg.default;
      Observer = ObserverPkg.default;

      gsap.registerPlugin(Observer);

      const container = containerRef.current!;
      // Fix: Avoid passing type argument to untyped function
      ...
      divItems.forEach((child: any, i: number) => {
